...
export default function Home() {
  return (
    <div className="space-y-16 pb-16">
      {/* Hero Section */}
      <section className="relative mx-4 mt-4 lg:mx-8 lg:mt-6 rounded-3xl overflow-hidden shadow-2xl border border-stone-800/20 min-h-[480px] lg:min-h-[560px] flex items-center">
        <div
          className="absolute inset-0 bg-cover bg-center transition-transform duration-1000 scale-100 hover:scale-105"
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1588347818036-c45e3e743fa8?auto=format&fit=crop&w=1920&q=80')",
          }}
        />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-16 text-white w-full">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              href="#meat-packs"
              className="px-6 py-3 bg-amber-500 hover:bg-amber-400 text-stone-950 font-black text-sm rounded-xl shadow-lg shadow-amber-500/30 transition-all hover:scale-105 active:scale-95"
            >
              Explore Freezer Packs
            </a>
            <a
              href="#custom-cuts"
              className="px-6 py-3 bg-white/10 hover:bg-white/20 text-white font-bold text-sm rounded-xl backdrop-blur-md border border-white/20 transition-all"
            >
              Custom Cut Order Wizard ↓
            </a>
            <a
              href="#heat-eat"
              className="px-6 py-3 bg-stone-900/90 hover:bg-stone-800 text-amber-300 font-bold text-sm rounded-xl border border-amber-500/30 transition-all"
            >
              Heat &amp; Eat Chef Meals ↓
            </a>
          </div>
      ...
      <section id="meat-packs" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {MEAT_PACKS.map((pack) => (
            <div
              key={pack.id}
              className="bg-white rounded-2xl border border-stone-200/90 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between overflow-hidden group"
            >
              <div className="p-6">
                ...
                <h3 className="text-xl font-black text-stone-950 mt-3 group-hover:text-amber-800 transition-colors">
                  {pack.name}
                </h3>
                <p className="text-xs text-stone-500 mt-1.5 leading-relaxed mb-4">
                  {pack.description}
                </p>
              ...
              <div className="p-6 bg-stone-50 border-t border-stone-100">
                <a
                  href="tel:0357213444"
                  className="w-full py-2.5 px-4 bg-stone-900 hover:bg-stone-800 text-white font-bold text-xs rounded-xl shadow transition-all flex items-center justify-center gap-2 group-hover:bg-amber-500 group-hover:text-stone-950"
                >
          ...
          <div className="bg-gradient-to-br from-stone-900 to-stone-950 text-white rounded-2xl p-6 flex flex-col justify-between border border-stone-800 shadow-lg">
            ...
            <div className="mt-6 pt-4 border-t border-stone-800">
              <a
                href="#custom-cuts"
                className="w-full py-2.5 px-4 bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold text-xs rounded-xl shadow transition-all flex items-center justify-center gap-2"
              >
      ...
      <section id="heat-eat" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-24">
        <div className="bg-stone-900 text-white rounded-3xl p-6 sm:p-10 lg:p-12 border border-stone-800 shadow-xl">
          ...
          <div className="mt-8 pt-6 border-t border-stone-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-stone-400">
            ...
            <a
              href="tel:0357213444"
              className="px-5 py-2.5 bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold rounded-xl shadow transition-colors flex items-center gap-2"
            >
      ...
      <section id="awards" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-24">
        <div className="bg-white rounded-3xl p-8 sm:p-10 border border-amber-500/30 shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-5 rounded-2xl bg-stone-50 border border-stone-200">
              ...
              <h4 className="font-bold text-stone-900 text-sm">Lamb, Fetta &amp; Sun-Dried Tomato</h4>
              <p className="text-xs text-amber-700 font-semibold mt-1">2025 AMIC Gold Medal</p>
              <p className="text-[11px] text-stone-500 mt-1">Gourmet Open Sausage Division</p>
            </div>

            <div className="p-5 rounded-2xl bg-stone-50 border border-stone-200">
              <span className="text-2xl mb-2 block">🥇</span>
              <h4 className="font-bold text-stone-900 text-sm">Chicken Sweet &amp; Sour Sausage</h4>
              <p className="text-xs text-amber-700 font-semibold mt-1">2025 AMIC Gold Medal</p>
              <p className="text-[11px] text-stone-500 mt-1">Poultry Sausage Category</p>
            </div>

            <div className="p-5 rounded-2xl bg-stone-50 border border-stone-200">
              <span className="text-2xl mb-2 block">🥇</span>
              <h4 className="font-bold text-stone-900 text-sm">Southern Chicken Burger</h4>
              <p className="text-xs text-amber-700 font-semibold mt-1">2025 AMIC Gold Medal</p>
              <p className="text-[11px] text-stone-500 mt-1">Best Butchers Burger Category</p>
            </div>

            <div className="p-5 rounded-2xl bg-stone-50 border border-stone-200">
              <span className="text-2xl mb-2 block">🥇</span>
              <h4 className="font-bold text-stone-900 text-sm">Lamb Fetta &amp; Mint Jelly Burger</h4>
              <p className="text-xs text-amber-700 font-semibold mt-1">2025 AMIC Gold Medal</p>
              <p className="text-[11px] text-stone-500 mt-1">Gourmet Burger Division</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-stone-900 text-white rounded-3xl p-8 border border-stone-800 shadow-xl space-y-4">
            ...
            <div className="pt-2">
              <a
                href="tel:0357213444"
                className="w-full py-3 bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold text-xs rounded-xl shadow transition-colors flex items-center justify-center gap-2"
              >
